          ...
          >
            ...
            {msg.files && msg.files.length > 0 && (
              <div style={{ marginTop: 8, display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {msg.files.map((file: { type: string; url: string | undefined }, i: Key | null | undefined) => {
                  ...
                  if (file.type.startsWith('audio/')) {
                    return (
                      <audio key={i} controls src={file.url} style={{ maxWidth: 150, borderRadius: 8 }} />
                    );
                  }
                  return (
                    <a
            ...
            {msg.audioUrl && !msg.files?.some((f: { type: string }) => f.type.startsWith('audio/')) && (
              <audio controls src={msg.audioUrl} style={{ marginTop: 8, maxWidth: 150, borderRadius: 8 }} />
            )}
